...
CLF_MODEL_PATH = "BestModel_Klasifikasi_Alg_William Luvianus_Selly Monica.pkl"
REG_MODEL_PATH = "BestModel_Regresi_Alg_William Luvianus_Selly Monica.pkl"
...
if menu == "🔍 Klasifikasi Gaya Belajar":
    ...
    if submitted:
        ...
        # Tambah kolom kategorikal yang diperlukan model klasifikasi
        X_input['Dalam satu semester terakhir, apakah Anda pernah mengulang mata kuliah? '] = 'Tidak'
        X_input['Dalam satu semester terakhir, apakah Anda pernah mendapat nilai D/E? '] = 'Tidak'
